...
CREATE TABLE kit (
    ...
    weight DOUBLE,
    notes TEXT,
    active INTEGER (1, 1) DEFAULT (1),
    toplevel INTEGER (1, 1) DEFAULT (1),
    cat INTEGER DEFAULT (0),
    img TEXT,
    stock_control INTEGER (1, 1) DEFAULT (1)
);
